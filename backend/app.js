...
app.use('/comentarios',isAuthenticated, require('./routes/comentario.js'));
app.get('/', (req, res)=>{
  res.send('holamundo desde node');
})
...
require('./database.js');//requerimos el archivo de conexion databese dockers
